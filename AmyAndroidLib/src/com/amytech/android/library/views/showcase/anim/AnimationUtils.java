package com.amytech.android.library.views.showcase.anim;
...
public class AnimationUtils {
	...
	public static AnimatorSet createMovementAnimation(View view, float canvasX, float canvasY, float offsetStartX, float offsetStartY, float offsetEndX,
			float offsetEndY, final AnimationEndListener listener) {
		ViewHelper.setAlpha(view, INVISIBLE);

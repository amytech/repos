...
public class DownloadRequest implements Comparable<DownloadRequest> {
	...
	public DownloadRequest setDestinationFile(String filePath) {
		return setDestinationFile(new File(filePath));
	}

	public DownloadRequest setDestinationFile(String fileParent, String fileName) {
		return setDestinationFile(new File(fileParent, fileName));
	}

	public DownloadRequest setDestinationFile(File saveFile) {
		this.mDestinationURI = Uri.parse(saveFile.getAbsolutePath());
		return this;
	}
	...
	public int compareTo(DownloadRequest other) {
		...
		// ordering.
		return left == right ? this.mDownloadId - other.mDownloadId : right.ordinal() - left.ordinal();
	}
}
